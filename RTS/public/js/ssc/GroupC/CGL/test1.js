const questions = [
    ...
    "options_en": ["B. R. Ambedkar", "Jawaharlal Nehru", "Rajendra Prasad", "Sardar Patel"],
    "options_hi": ["बी. आर. अंबेडकर", "जवाहरलाल नेहरू", "राजेंद्र प्रसाद", "सरदार पटेल"],
  ...
  },
  {
    ...
    "options_en": ["Dr. Rajendra Prasad", "S. Radhakrishnan", "Jawaharlal Nehru", "Zakir Hussain"],
    "options_hi": ["डॉ. राजेंद्र प्रसाद", "एस. राधाकृष्णन", "जवाहरलाल नेहरू", "जाकिर हुसैन"],
  ...
  {
    "num": 5,
    "question_en": "Which gas is used for respiration?",
    "question_hi": "श्वसन के लिए कौन सी गैस उपयोग होती है?",
  ...
  },
  {
    ...
    "options_en": ["Alexander Graham Bell", "Edison", "Newton", "Marconi"],
    "options_hi": ["अलेक्जेंडर ग्राहम बेल", "एडिसन", "न्यूटन", "मार्कोनी"],
  ...
  },
  {
    ...
    "question_hi": "सनशाइन विटामिन किसे कहा जाता है?",
    "options_en": ["Vitamin D", "Vitamin A", "Vitamin C", "Vitamin E"],
    "options_hi": ["विटामिन D", "विटामिन A", "विटामिन C", "विटामिन E"],
    "answer_en": "Vitamin D",
    "answer_hi": "विटामिन D",
    "attempted": false,
    "selected": ""
...

  {
    ...
    "question_hi": "स्टैच्यू ऑफ लिबर्टी किस देश ने अमेरिका को भेंट की?",
  ...
  },
  {
    ...
    "options_hi": ["रवींद्रनाथ टैगोर", "बंकिम चंद्र चटर्जी", "सुभाष चंद्र बोस", "महात्मा गांधी"],
  ...
  },
  {
    ...
    "options_en": ["Kosi", "Ganga", "Ghaghara", "Son"],
    "options_hi": ["कोसी", "गंगा", "घाघरा", "सोन"],
    "answer_en": "Kosi",
    "answer_hi": "कोसी",
    "attempted": false,
    "selected": ""
  ...
  },
  {
    ...
    "options_en": ["Sardar Patel", "Bhagat Singh", "Jawaharlal Nehru", "Lal Bahadur Shastri"],
    "options_hi": ["सरदार पटेल", "भगत सिंह", "जवाहरलाल नेहरू", "लाल बहादुर शास्त्री"],
  ...
  },
  {
    ...
    "options_en": ["Shah Jahan", "Akbar", "Babur", "Jahangir"],
    "options_hi": ["शाहजहाँ", "अकबर", "बाबर", "जहाँगीर"],
  ...
  },
  {
    ...
    "options_en": ["O negative", "O positive", "AB positive", "AB negative"],
    "options_hi": ["O नेगेटिव", "O पॉजिटिव", "AB पॉजिटिव", "AB नेगेटिव"],
  ...
  {
    "num": 31,
    "question_en": "Which continent is called the Dark Continent?",
  ...
  },
  {
    ...
    "question_hi": "बिजली के तार बनाने में कौन सी धातु प्रयुक्त होती है?",
    "options_en": ["Copper", "Iron", "Aluminium", "Zinc"],
    "options_hi": ["तांबा", "लोहा", "एल्युमिनियम", "जस्ता"],
    "answer_en": "Copper",
    "answer_hi": "तांबा",
    "attempted": false,
    "selected": ""
  ...
  },
  {
    ...
    "options_en": ["Thomas Edison", "Newton", "Einstein", "Faraday"],
    "options_hi": ["थॉमस एडिसन", "न्यूटन", "आइंस्टीन", "फैराडे"],
  ...
  },
  {
    ...
    "question_hi": "चाय बागानों के लिए प्रसिद्ध भारतीय राज्य कौन सा है?",
    "options_en": ["Assam", "Kerala", "Bihar", "Odisha"],
    "options_hi": ["असम", "केरल", "बिहार", "ओडिशा"],
    "answer_en": "Assam",
    "answer_hi": "असम",
    "attempted": false,
    "selected": ""
  },
  {
    ...
    "options_en": ["Vitamin C", "Vitamin D", "Vitamin A", "Vitamin B12"],
    "options_hi": ["विटामिन C", "विटामिन D", "विटामिन A", "विटामिन B12"],
    "answer_en": "Vitamin C",
    "answer_hi": "विटामिन C",
    "attempted": false,
    "selected": ""
  },
  {
    ...
    "question_hi": "कौन से भारतीय स्वतंत्रता सेनानी 'नेताजी' के नाम से प्रसिद्ध हैं?",
  ...
  },
  {
    ...
    "question_hi": "विश्व का सबसे बड़ा स्तनधारी कौन सा है?",
  ...
  },
  {
    ...
    "options_en": ["Citric Acid", "Acetic Acid", "Lactic Acid", "Sulphuric Acid"],
    "options_hi": ["सिट्रिक अम्ल", "एसिटिक अम्ल", "लैक्टिक अम्ल", "सल्फ्यूरिक अम्ल"],
  ...
  },
  {
    ...
    "options_hi": ["सेरिबेलम", "सेरिब्रम", "मेडुला", "हाइपोथैलेमस"],
  ...
  },
  {
    ...
    "options_en": ["Rectifier", "Transformer", "Generator", "Inverter"],
    "options_hi": ["रेक्टिफायर", "ट्रांसफॉर्मर", "जनरेटर", "इन्वर्टर"],
    "answer_en": "Rectifier",
