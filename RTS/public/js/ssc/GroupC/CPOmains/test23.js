const questions = [
    ...
    "options_hi": ["केरल", "गोवा", "मिजोरम", "तमिलनाडु"],
    "answer_en": "Kerala",
    "answer_hi": "केरल",
    "attempted": false,
    "selected": ""
  ...
  {
    "num":4,
    "question_en": "Which gas is used to extinguish fire?",
    "question_hi": "आग बुझाने के लिए कौन सी गैस प्रयोग होती है?",
  ...
  },
  {
    ...
    "options_en": ["Jaipur", "Jodhpur", "Bikaner", "Ajmer"],
    "options_hi": ["जयपुर", "जोधपुर", "बीकानेर", "अजमेर"],
    "answer_en": "Jaipur",
    "answer_hi": "जयपुर",
    "attempted": false,
    "selected": ""
  ...
  },
  {
    ...
    "question_hi": "'भारत का चाय बागान' किस राज्य को कहा जाता है?",
  ...
  },
  {
    ...
    "options_en": ["Dr. Rajendra Prasad", "Jawaharlal Nehru", "S. Radhakrishnan", "V. V. Giri"],
    "options_hi": ["डॉ. राजेंद्र प्रसाद", "जवाहरलाल नेहरू", "एस. राधाकृष्णन", "वी. वी. गिरि"],
  ...
  },
  {
    ...
    "question_hi": "एस्कॉर्बिक एसिड किस विटामिन को कहते हैं?",
  ...
  {
    "num":18,
    "question_en": "Which Indian monument is also called the White Marble Wonder?",
    "question_hi": "'सफेद संगमरमर का अजूबा' किसे कहा जाता है?",
    "options_en": ["Taj Mahal", "Victoria Memorial", "Qutub Minar", "Red Fort"],
    "options_hi": ["ताजमहल", "विक्टोरिया मेमोरियल", "कुतुब मीनार", "लाल किला"],
    "answer_en": "Taj Mahal",
    "answer_hi": "ताजमहल",
    "attempted": false,
    "selected": ""
  ...
  {
    "num":20,
    "question_en": "Which Indian state has the longest coastline after Gujarat?",
    "question_hi": "गुजरात के बाद सबसे लंबा समुद्र तट किस राज्य का है?",
    "options_en": ["Andhra Pradesh", "Tamil Nadu", "Kerala", "Odisha"],
    "options_hi": ["आंध्र प्रदेश", "तमिलनाडु", "केरल", "ओडिशा"],
  ...
  {
    "num":30,
    "question_en": "Which Indian monument is called the Red Fort?",
  ...
  },
  {
    ...
    "question_hi": "विद्युत तार बनाने में कौन सी धातु उपयोग होती है?",
  ...
  },
  {
    ...
    "options_en": ["Himachal Pradesh", "Uttarakhand", "Jammu & Kashmir", "Sikkim"],
    "options_hi": ["हिमाचल प्रदेश", "उत्तराखंड", "जम्मू और कश्मीर", "सिक्किम"],
  ...
  },
  {
    ...
    "options_en": ["Hydrogen", "Nitrogen", "Helium", "Oxygen"],
    "options_hi": ["हाइड्रोजन", "नाइट्रोजन", "हीलियम", "ऑक्सीजन"],
    "answer_en": "Helium",
    "answer_hi": "हीलियम",
    "attempted": false,
    "selected": ""
  ...
  },
  {
    ...
    "question_hi": "'भारत का चावल कटोरा' किस राज्य को कहा जाता है?",
    "options_en": ["West Bengal", "Andhra Pradesh", "Odisha", "Chhattisgarh"],
    "options_hi": ["पश्चिम बंगाल", "आंध्र प्रदेश", "ओडिशा", "छत्तीसगढ़"],
    "answer_en": "Andhra Pradesh",
    "answer_hi": "आंध्र प्रदेश",
    "attempted": false,
    "selected": ""
  ...
  },
  {
    ...
    "options_hi": ["होली", "दिवाली", "ईद", "बैसाखी"],
    "answer_en": "Diwali",
    "answer_hi": "दिवाली",
    "attempted": false,
    "selected": ""
  },
  {
    ...
    "question_hi": "पाचन में सहायक अंग कौन सा है?",
  ...
  },
  {
    ...
    "question_hi": "सेब के लिए कौन सा राज्य प्रसिद्ध है?",
    "options_en": ["Himachal Pradesh", "Punjab", "Sikkim", "Arunachal Pradesh"],
    "options_hi": ["हिमाचल प्रदेश", "पंजाब", "सिक्किम", "अरुणाचल प्रदेश"],
  ...
  },
  {
    ...
    "options_en": ["Jawaharlal Nehru", "Dr. B. R. Ambedkar", "Rajendra Prasad", "Sardar Patel"],
    "options_hi": ["जवाहरलाल नेहरू", "डॉ. बी. आर. अंबेडकर", "राजेंद्र प्रसाद", "सरदार पटेल"],
  ...
  },
  {
    ...
    "question_hi": "कौन सी नदी बंगाल की खाड़ी में गिरती है?",
    "options_en": ["Narmada", "Yamuna", "Ganga", "Tapti"],
    "options_hi": ["नर्मदा", "यमुना", "गंगा", "ताप्ती"],
    "answer_en": "Ganga",
    "answer_hi": "गंगा",
    "attempted": false,
    "selected": ""
  },
  {
    ...
    "question_hi": "अत्यंत छोटे वस्तुओं को देखने के लिए कौन सा यंत्र उपयोग होता है?",
    "options_en": ["Telescope", "Microscope", "Periscope", "Binoculars"],
    "options_hi": ["दूरबीन", "सूक्ष्मदर्शी", "पेरिस्कोप", "द्विनेत्री"],
  ...
  },
  {
    ...
    "options_en": ["Uttarakhand", "Himachal Pradesh", "Arunachal Pradesh", "Sikkim"],
    "options_hi": ["उत्तराखंड", "हिमाचल प्रदेश", "अरुणाचल प्रदेश", "सिक्किम"],
