...
{
    "num":1,
    "question_en": "Which Indian satellite was the first to be launched using a foreign launch vehicle?",
    "question_hi": "कौन सा भारतीय उपग्रह विदेशी प्रक्षेपण यान का उपयोग करके प्रक्षेपित किया जाने वाला पहला उपग्रह था?",
    "options_en": ["Aryabhata", "Bhaskara-I", "Rohini", "Apple"],
    "options_hi": ["आर्यभट्ट", "भास्कर-I", "रोहिणी", "एप्पल"],
    "answer_en": "Aryabhata",
    "answer_hi": "आर्यभट्ट",
    "attempted": false,
    "selected": ""
  ...
  {
    "num":2,
    "question_en": "What is the primary component of natural gas?",
    "question_hi": "प्राकृतिक गैस का प्राथमिक घटक क्या है?",
  ...
  {
    "num":3,
    "question_en": "Which chemical element has the highest melting point?",
    "question_hi": "किस रासायनिक तत्व का गलनांक सबसे अधिक है?",
  ...
  },
  {
    ...
    "options_en": ["Katal", "Mole", "Becquerel", "Siemens"],
    "options_hi": ["कैटल", "मोल", "बेकरेल", "सीमेंस"],
    "answer_en": "Katal",
    "answer_hi": "कैटल",
    "attempted": false,
    "selected": ""
  ...
  {
    "num":5,
    "question_en": "Which planet in our solar system has the shortest day?",
    "question_hi": "हमारे सौर मंडल में किस ग्रह का दिन सबसे छोटा है?",
  ...
  },
  {
    ...
    "options_hi": ["ऑक्सीजन ले जाना", "संक्रमण से लड़ना", "रक्त का थक्का जमाना", "पोषक तत्वों का परिवहन"],
  ...
  {
    "num":8,
    "question_en": "What type of radiation is used in MRI scans?",
    "question_hi": "एमआरआई स्कैन में किस प्रकार का विकिरण प्रयोग किया जाता है?",
    "options_en": ["X-rays", "Radio waves", "Gamma rays", "Ultraviolet rays"],
    "options_hi": ["एक्स-रे", "रेडियो तरंगें", "गामा किरणें", "पराबैंगनी किरणें"],
  ...
  {
    "num":9,
    "question_en": "Which scientist proposed the wave theory of light?",
    "question_hi": "किस वैज्ञानिक ने प्रकाश की तरंग सिद्धांत प्रस्तावित किया?",
    "options_en": ["Isaac Newton", "Christiaan Huygens", "James Clerk Maxwell", "Thomas Young"],
    "options_hi": ["आइजैक न्यूटन", "क्रिश्चियन ह्यूजेंस", "जेम्स क्लर्क मैक्सवेल", "थॉमस यंग"],
    "answer_en": "Christiaan Huygens",
    "answer_hi": "क्रिश्चियन ह्यूजेंस",
    "attempted": false,
    "selected": ""
  },
  {
    "num":10,
    "question_en": "What is the chemical formula for ozone?",
    "question_hi": "ओजोन का रासायनिक सूत्र क्या है?",
    "options_en": ["O2", "O3", "H2O", "CO2"],
    "options_hi": ["O2", "O3", "H2O", "CO2"],
    "answer_en": "O3",
    "answer_hi": "O3",
    "attempted": false,
    "selected": ""
  ...
  },
  {
    ...
    "question_hi": "पृथ्वी के वातावरण में कौन सी गैस सबसे अधिक मात्रा में पाई जाती है?",
  ...
  },
  {
    ...
    "options_hi": ["सोना", "लोहा", "हीरा", "क्वार्ट्ज"],
    "answer_en": "Diamond",
    "answer_hi": "हीरा",
    "attempted": false,
    "selected": ""
  },
  {
    ...
    "options_en": ["Mercury", "Bromine", "Both A and B", "Gallium"],
    "options_hi": ["पारा", "ब्रोमीन", "A और B दोनों", "गैलियम"],
  ...
  {
    "num":28,
    "question_en": "What is the study of mushrooms called?",
    "question_hi": "मशरूम के अध्ययन को क्या कहा जाता है?",
    "options_en": ["Mycology", "Phycology", "Bryology", "Lichenology"],
    "options_hi": ["कवक विज्ञान", "शैवाल विज्ञान", "ब्रायोलॉजी", "लाइकेनोलॉजी"],
    "answer_en": "Mycology",
  ...
  },
  {
    ...
    "options_hi": ["नियॉन", "आर्गन", "जेनॉन", "क्रिप्टॉन"],
    "answer_en": "Argon",
    "answer_hi": "आर्गन",
    "attempted": false,
    "selected": ""
  },
  {
    ...
    "options_en": ["Liver", "Skin", "Lungs", "Intestine"],
    "options_hi": ["यकृत", "त्वचा", "फेफड़े", "आंत"],
    "answer_en": "Skin",
    "answer_hi": "त्वचा",
    "attempted": false,
    "selected": ""
  ...
  },
  {
    ...
    "options_en": ["Curie", "Becquerel", "Rutherford", "All of these"],
    "options_hi": ["क्यूरी", "बेकरेल", "रदरफोर्ड", "उपरोक्त सभी"],
  ...
  },
  {
    ...
    "options_hi": ["एम्पीयर", "कूलॉम", "वोल्ट", "ओम"],
    "answer_en": "Coulomb",
    "answer_hi": "कूलॉम",
    "attempted": false,
    "selected": ""
  ...
  {
    "num":39,
    "question_en": "Which blood group is known as the universal recipient?",
    "question_hi": "किस रक्त समूह को सार्वत्रिक प्राप्तकर्ता के रूप में जाना जाता है?",
    "options_en": ["A+", "B+", "AB+", "O+"],
    "options_hi": ["A+", "B+", "AB+", "O+"],
    "answer_en": "AB+",
    "answer_hi": "AB+",
  ...
  },
  {
    ...
    "question_hi": "कौन सी धातु कमरे के तापमान पर तरल अवस्था में होती है?",
    "options_en": ["Mercury", "Gallium", "Francium", "All of these"],
    "options_hi": ["पारा", "गैलियम", "फ्रांसियम", "उपरोक्त सभी"],
    "answer_en": "All of these",
    "answer_hi": "उपरोक्त सभी",
    "attempted": false,
    "selected": ""
  ...
  {
    "num":42,
    "question_en": "What is the pH value of lemon juice?",
    "question_hi": "नींबू के रस का pH मान क्या है?",
    "options_en": ["2-3", "4-5", "6-7", "8-9"],
    "options_hi": ["2-3", "4-5", "6-7", "8-9"],
    "answer_en": "2-3",
    "answer_hi": "2-3",
    "attempted": false,
    "selected": ""
  ...
  },
  {
    ...
    "question_hi": "किस ग्रह के वलय हैं?",
    "options_en": ["Jupiter", "Saturn", "Uranus", "All of these"],
    "options_hi": ["बृहस्पति", "शनि", "यूरेनस", "उपरोक्त सभी"],
    "answer_en": "All of these",
    "answer_hi": "उपरोक्त सभी",
    "attempted": false,
    "selected": ""
  },
  {
    ...
    "options_en": ["Sodium carbonate", "Sodium bicarbonate", "Calcium carbonate", "Potassium carbonate"],
    "options_hi": ["सोडियम कार्बोनेट", "सोडियम बाइकार्बोनेट", "कैल्शियम कार्बोनेट", "पोटेशियम कार्बोनेट"],
  ...
  },
  {
    ...
    "question_hi": "शैवाल के अध्ययन को क्या कहा जाता है?",
    "options_en": ["Mycology", "Phycology", "Bryology", "Lichenology"],
    "options_hi": ["कवक विज्ञान", "शैवाल विज्ञान", "ब्रायोलॉजी", "लाइकेनोलॉजी"],
    "answer_en": "Phycology",
  ...
  },
  {
    ...
    "options_en": ["Neon", "Argon", "Xenon", "Helium"],
    "options_hi": ["नियॉन", "आर्गन", "जेनॉन", "हीलियम"],
    "answer_en": "Neon",
    "answer_hi": "नियॉन",
    "attempted": false,
    "selected": ""
  },
  {
    ...
    "options_en": ["Stapes", "Malleus", "Incus", "Coccyx"],
    "options_hi": ["स्टेपीज", "मैलियस", "इनकस", "कोक्सिक्स"],
    "answer_en": "Stapes",
    "answer_hi": "स्टेपीज",
    "attempted": false,
    "selected": ""
