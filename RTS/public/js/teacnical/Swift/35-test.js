const questions=[
  {
    "num": 1,
    "question_en": "Swift was introduced by which company?",
    "question_hi": "Swift किस company द्वारा introduce की गई थी?",
  ...
  {
    "num": 5,
    "question_en": "Which data type is used for decimal numbers in Swift?",
    "question_hi": "Swift में decimal numbers के लिए कौन सा data type उपयोग होता है?",
    "options_en": ["Double", "Int", "Bool", "Character"],
    "options_hi": ["Double", "Int", "Bool", "Character"],
    "answer_en": "Double",
    "answer_hi": "Double",
    "attempted": false,
    "selected": ""
  },
  {
    ...
    "question_hi": "Swift में true/false को represent करने वाला data type कौन सा है?",
  ...
  },
  {
    ...
    "question_hi": "Swift में enumeration define करने के लिए कौन सा keyword है?",
...

  {
    ...
    "question_hi": "Swift में force unwrapping के लिए कौन सा operator उपयोग होता है?",
    "options_en": ["!", "?", "??", "&"],
    "options_hi": ["!", "?", "??", "&"],
    "answer_en": "!",
    "answer_hi": "!",
  ...
  {
    "num": 23,
    "question_en": "Which keyword returns a value from a function?",
    "question_hi": "Swift में function से value return करने के लिए कौन सा keyword है?",
    "options_en": ["return", "send", "exit", "yield"],
    "options_hi": ["return", "send", "exit", "yield"],
    "answer_en": "return",
    "answer_hi": "return",
    "attempted": false,
    "selected": ""
  ...
  },
  {
    ...
    "question_hi": "Swift में error throw करने वाले function के लिए कौन सा keyword है?",
  ...
  },
  {
    ...
    "question_hi": "Swift में superclass के methods access करने के लिए कौन सा keyword है?",
  ...
  },
  {
    ...
    "question_hi": "Swift में asynchronous function के लिए कौन सा keyword उपयोग होता है?",
  ...
  {
    "num": 36,
    "question_en": "Which attribute marks program entry point?",
  ...
  {
    "num": 37,
    "question_en": "Which attribute checks API availability?",
    "question_hi": "Swift में API availability check करने के लिए कौन सा attribute है?",
    "options_en": ["@available", "@objc", "@discardableResult", "@testable"],
    "options_hi": ["@available", "@objc", "@discardableResult", "@testable"],
    "answer_en": "@available",
    "answer_hi": "@available",
    "attempted": false,
    "selected": ""
  ...
  {
    "num": 39,
    "question_en": "Which feature provides value semantics?",
  ...
  {
    "num": 40,
    "question_en": "Which feature provides reference semantics?",
  ...
  {
    "num": 42,
    "question_en": "Which keyword allows subclassing outside a module?",
  ...
  {
    "num": 43,
    "question_en": "Which keyword makes a reference weak?",
    "question_hi": "Swift में weak reference बनाने के लिए कौन सा keyword है?",
    "options_en": ["weak", "unowned", "lazy", "strong"],
    "options_hi": ["weak", "unowned", "lazy", "strong"],
    "answer_en": "weak",
    "answer_hi": "weak",
    "attempted": false,
    "selected": ""
  ...
  {
    "num": 44,
    "question_en": "Which keyword creates an unowned reference?",
  ...
  {
    "num": 45,
    "question_en": "Which feature supports protocol-based design?",
    "question_hi": "Swift में protocol-based design किस feature से support होता है?",
    "options_en": ["Protocol Oriented Programming", "OOP", "Functional", "MVC"],
    "options_hi": ["Protocol Oriented Programming", "OOP", "Functional", "MVC"],
  ...
  {
    "num": 48,
    "question_en": "Which keyword makes a property read-only?",
    "question_hi": "Swift में property को read-only बनाने के लिए कौन सा keyword है?",
  ...
  },
  {
    ...
    "question_hi": "Swift में module import करने के लिए कौन सा keyword है?",
  ...
  },
  {
    ...
    "question_hi": "Swift files की extension क्या होती है?",
