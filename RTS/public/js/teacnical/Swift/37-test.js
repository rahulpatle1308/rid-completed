const questions=[
  {
    "num": 1,
    "question_en": "Swift was developed by which company?",
    "question_hi": "Swift किस company द्वारा develop की गई है?",
  ...
  {
    "num": 5,
    "question_en": "Which data type is used for decimal values in Swift?",
    "question_hi": "Swift में decimal values के लिए कौन सा data type उपयोग होता है?",
  ...
  {
    "num": 9,
    "question_en": "Which collection type stores ordered values?",
    "question_hi": "Swift में ordered values store करने के लिए कौन सा collection type है?",
  ...
  },
  {
    ...
    "question_hi": "Swift में optional को safely unwrap करने के लिए कौन सा keyword है?",
    "options_en": ["if let", "unwrap", "check", "bind"],
    "options_hi": ["if let", "unwrap", "check", "bind"],
    "answer_en": "if let",
    "answer_hi": "if let",
    "attempted": false,
    "selected": ""
  ...
  {
    "num": 23,
    "question_en": "Which keyword is used to return a value?",
    "question_hi": "Swift में value return करने के लिए कौन सा keyword है?",
  ...
  },
  {
    ...
    "question_hi": "Swift में asynchronous functions के लिए कौन सा keyword है?",
  ...
  {
    "num": 35,
    "question_en": "Which keyword waits for an async result?",
  ...
  {
    "num": 36,
    "question_en": "Which attribute marks the program entry point?",
  ...
  {
    "num": 45,
    "question_en": "Which design approach is promoted by Swift?",
    "question_hi": "Swift किस design approach को promote करता है?",
