const questions=[
    ...
    {
        "num": 4,
        "question_en": "How do you create a new goroutine in Go?",
        "question_hi": "Go में नई गोरूटीन कैसे बनाते हैं?",
    ...
    },
    {
        ...
        "options_en": ["To schedule a function call to run after the surrounding function returns", "To delay execution", "To stop execution", "To speed up execution"],
        "options_hi": ["सराउंडिंग फंक्शन के रिटर्न होने के बाद फंक्शन कॉल को शेड्यूल करने के लिए", "एक्सेक्यूशन डिले करने के लिए", "एक्सेक्यूशन रोकने के लिए", "एक्सेक्यूशन स्पीड अप करने के लिए"],
        "answer_en": "To schedule a function call to run after the surrounding function returns",
        "answer_hi": "सराउंडिंग फंक्शन के रिटर्न होने के बाद फंक्शन कॉल को शेड्यूल करने के लिए",
        "attempted": false,
        "selected": ""
    },
    {
        "num": 7,
        "question_en": "How do you check if a map contains a key in Go?",
        "question_hi": "Go में कैसे चेक करते हैं कि मैप में कोई की है या नहीं?",
    ...
    },
    {
        ...
        "options_en": [":= declares and initializes, = only assigns", "No difference", "= declares and initializes, := only assigns", ":= is for constants"],
        "options_hi": [":= डिक्लेयर और इनिशियलाइज़ करता है, = केवल असाइन करता है", "कोई अंतर नहीं", "= डिक्लेयर और इनिशियलाइज़ करता है, := केवल असाइन करता है", ":= कॉन्स्टेंट के लिए है"],
        "answer_en": ":= declares and initializes, = only assigns",
        "answer_hi": ":= डिक्लेयर और इनिशियलाइज़ करता है, = केवल असाइन करता है",
        "attempted": false,
        "selected": ""
    },
    {
    ...
    },
    {
        ...
        "options_en": ["To iterate over arrays, slices, maps, strings, or channels", "To define a range of numbers", "To set value ranges", "To limit function scope"],
        "options_hi": ["ऐरे, स्लाइस, मैप, स्ट्रिंग या चैनल पर इटरेट करने के लिए", "नंबर की रेंज डिफाइन करने के लिए", "वैल्यू रेंज सेट करने के लिए", "फंक्शन स्कोप लिमिट करने के लिए"],
        "answer_en": "To iterate over arrays, slices, maps, strings, or channels",
        "answer_hi": "ऐरे, स्लाइस, मैप, स्ट्रिंग या चैनल पर इटरेट करने के लिए",
        "attempted": false,
        "selected": ""
    },
    {
    ...
    },
    {
        ...
        "question_hi": "Go में स्ट्रिंग को बाइट स्लाइस में कैसे कन्वर्ट करते हैं?",
    ...
    {
        "num": 16,
        "question_en": "Which method is called automatically when a struct is printed in Go?",
        "question_hi": "Go में जब स्ट्रक्ट प्रिंट किया जाता है तो कौन सी मेथड ऑटोमैटिकली कॉल होती है?",
    ...
    {
        "num": 17,
        "question_en": "What is the zero value of numeric types in Go?",
        "question_hi": "Go में न्यूमेरिक टाइप का जीरो वैल्यू क्या है?",
    ...
    {
        "num": 19,
        "question_en": "What is the purpose of the 'iota' identifier in Go?",
        "question_hi": "Go में 'iota' आइडेंटिफायर का उद्देश्य क्या है?",
    ...
    {
        "num": 20,
        "question_en": "Which package is used for HTTP server and client implementation in Go?",
        "question_hi": "Go में HTTP सर्वर और क्लाइंट इम्प्लीमेंटेशन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 22,
        "question_en": "What is the purpose of the 'recover' function in Go?",
    ...
    {
        "num": 24,
        "question_en": "What is the purpose of the 'cap' function in Go?",
        "question_hi": "Go में 'cap' फंक्शन का उद्देश्य क्या है?",
    ...
    {
        "num": 26,
        "question_en": "What is the zero value of a struct in Go?",
        "question_hi": "Go में स्ट्रक्ट का जीरो वैल्यू क्या है?",
    ...
    {
        "num": 27,
        "question_en": "Which package is used for JSON encoding and decoding in Go?",
        "question_hi": "Go में JSON एन्कोडिंग और डिकोडिंग के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 28,
        "question_en": "What is the purpose of the 'len' function in Go?",
        "question_hi": "Go में 'len' फंक्शन का उद्देश्य क्या है?",
    ...
    {
        "num": 30,
        "question_en": "What is the purpose of the 'close' function for channels in Go?",
        "question_hi": "Go में चैनल के लिए 'close' फंक्शन का उद्देश्य क्या है?",
    ...
    {
        "num": 32,
        "question_en": "What is the purpose of the 'new' function in Go?",
    ...
    {
        "num": 33,
        "question_en": "What is the purpose of the 'append' function in Go?",
        "question_hi": "Go में 'append' फंक्शन का उद्देश्य क्या है?",
    ...
    {
        "num": 34,
        "question_en": "Which package is used for working with time in Go?",
        "question_hi": "Go में टाइम के साथ काम करने के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 37,
        "question_en": "What is the purpose of the 'copy' function in Go?",
        "question_hi": "Go में 'copy' फंक्शन का उद्देश्य क्या है?",
    ...
    {
        "num": 38,
        "question_en": "Which package is used for file operations in Go?",
        "question_hi": "Go में फाइल ऑपरेशन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 39,
        "question_en": "What is the purpose of the 'panic' function in Go?",
        "question_hi": "Go में 'panic' फंक्शन का उद्देश्य क्या है?",
    ...
    {
        "num": 40,
        "question_en": "How do you import a package with a different name in Go?",
        "question_hi": "Go में डिफरेंट नाम के साथ पैकेज कैसे इम्पोर्ट करते हैं?",
    ...
    {
        "num": 41,
        "question_en": "What is the purpose of the 'delete' function in Go?",
        "question_hi": "Go में 'delete' फंक्शन का उद्देश्य क्या है?",
    ...
    {
        "num": 42,
        "question_en": "Which package is used for string manipulation in Go?",
        "question_hi": "Go में स्ट्रिंग मैनिपुलेशन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 44,
        "question_en": "How do you create a custom type in Go?",
        "question_hi": "Go में कस्टम टाइप कैसे बनाते हैं?",
    ...
    {
        "num": 46,
        "question_en": "Which package is used for mathematical operations in Go?",
        "question_hi": "Go में मैथमेटिकल ऑपरेशन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 47,
        "question_en": "What is the purpose of the 'rune' type in Go?",
        "question_hi": "Go में 'rune' टाइप का उद्देश्य क्या है?",
    ...
    {
        "num": 50,
        "question_en": "Which package is used for command-line flag parsing in Go?",
        "question_hi": "Go में कमांड-लाइन फ्लैग पार्सिंग के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    },
    {
        ...
        "question_hi": "Go में मल्टीपल रिटर्न वैल्यू को कैसे हैंडल करते हैं?",
    ...
    {
        "num": 54,
        "question_en": "Which package is used for random number generation in Go?",
        "question_hi": "Go में रैंडम नंबर जनरेशन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 56,
        "question_en": "How do you create a variadic function in Go?",
        "question_hi": "Go में वेरिएडिक फंक्शन कैसे बनाते हैं?",
    ...
    {
        "num": 58,
        "question_en": "Which package is used for cryptographic functions in Go?",
        "question_hi": "Go में क्रिप्टोग्राफिक फंक्शन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 62,
        "question_en": "Which package is used for compression in Go?",
        "question_hi": "Go में कम्प्रेशन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 64,
        "question_en": "How do you implement a read-write mutex in Go?",
        "question_hi": "Go में रीड-राइट म्यूटेक्स कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 66,
        "question_en": "Which package is used for regular expressions in Go?",
        "question_hi": "Go में रेगुलर एक्सप्रेशन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 70,
        "question_en": "Which package is used for context management in Go?",
        "question_hi": "Go में कॉन्टेक्स्ट मैनेजमेंट के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 72,
        "question_en": "How do you create a function type in Go?",
        "question_hi": "Go में फंक्शन टाइप कैसे बनाते हैं?",
    ...
    {
        "num": 74,
        "question_en": "Which package is used for template processing in Go?",
        "question_hi": "Go में टेम्पलेट प्रोसेसिंग के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 76,
        "question_en": "How do you create a method with pointer receiver in Go?",
        "question_hi": "Go में पॉइंटर रिसीवर के साथ मेथड कैसे बनाते हैं?",
    ...
    {
        "num": 78,
        "question_en": "Which package is used for atomic operations in Go?",
        "question_hi": "Go में एटॉमिक ऑपरेशन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 80,
        "question_en": "How do you create a type assertion in Go?",
        "question_hi": "Go में टाइप असर्शन कैसे बनाते हैं?",
    ...
    {
        "num": 82,
        "question_en": "Which package is used for reflection in Go?",
        "question_hi": "Go में रिफ्लेक्शन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 84,
        "question_en": "How do you create a type switch in Go?",
        "question_hi": "Go में टाइप स्विच कैसे बनाते हैं?",
    ...
    {
        "num": 86,
        "question_en": "Which package is used for binary data reading and writing in Go?",
        "question_hi": "Go में बाइनरी डेटा रीडिंग और राइटिंग के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 88,
        "question_en": "How do you create a custom error type in Go?",
        "question_hi": "Go में कस्टम एरर टाइप कैसे बनाते हैं?",
    ...
    {
        "num": 90,
        "question_en": "Which package is used for SQL database operations in Go?",
        "question_hi": "Go में SQL डेटाबेस ऑपरेशन के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 92,
        "question_en": "How do you create a method on a non-struct type in Go?",
        "question_hi": "Go में नॉन-स्ट्रक्ट टाइप पर मेथड कैसे बनाते हैं?",
    ...
    {
        "num": 94,
        "question_en": "Which package is used for HTTP/2 support in Go?",
        "question_hi": "Go में HTTP/2 सपोर्ट के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 96,
        "question_en": "How do you create a generic function in Go?",
        "question_hi": "Go में जेनरिक फंक्शन कैसे बनाते हैं?",
    ...
    {
        "num": 98,
        "question_en": "Which package is used for profiling in Go?",
        "question_hi": "Go में प्रोफाइलिंग के लिए किस पैकेज का उपयोग किया जाता है?",
    ...
    {
        "num": 100,
        "question_en": "How do you create a type constraint in Go?",
        "question_hi": "Go में टाइप कंस्ट्रेंट कैसे बनाते हैं?",
