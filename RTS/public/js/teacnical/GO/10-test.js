const questions = [
    {
        ...
        "options_en": ["Package initialization", "Program startup", "Variable declaration", "Error handling"],
        "options_hi": ["पैकेज इनिशियलाइजेशन", "प्रोग्राम स्टार्टअप", "वेरिएबल डिक्लेरेशन", "एरर हैंडलिंग"],
    ...
    {
        "num": 3,
        "question_en": "What is the zero value for slices?",
    ...
    {
        "num": 4,
        "question_en": "How do you implement method chaining?",
        "question_hi": "मेथड चेनिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    },
    {
        ...
        "options_en": ["Read-write mutual exclusion", "Reading only", "Writing only", "Synchronization"],
        "options_hi": ["रीड-राइट म्यूचुअल एक्सक्लूजन", "केवल रीडिंग", "केवल राइटिंग", "सिंक्रोनाइजेशन"],
        "answer_en": "Read-write mutual exclusion",
        "answer_hi": "रीड-राइट म्यूचुअल एक्सक्लूजन",
        "attempted": false,
        "selected": ""
    },
    {
        "num": 6,
        "question_en": "How do you implement function composition?",
        "question_hi": "फंक्शन कम्पोजिशन कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 7,
        "question_en": "What is the purpose of 'time.Sleep'?",
        "question_hi": "'time.Sleep' का उद्देश्य क्या है?",
        "options_en": ["Pause execution", "Sleep goroutine", "Delay operations", "All of the above"],
        "options_hi": ["एक्जीक्यूशन पॉज करना", "गोरूटीन स्लीप करना", "ऑपरेशन्स डिले करना", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 8,
        "question_en": "How do you implement custom string formatting?",
        "question_hi": "कस्टम स्ट्रिंग फॉर्मेटिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    },
    {
        ...
        "options_en": ["Execute function only once", "Run once per program", "For initialization", "All of the above"],
        "options_hi": ["फंक्शन को केवल एक बार एक्जीक्यूट करना", "प्रोग्राम में एक बार रन करना", "इनिशियलाइजेशन के लिए", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 10,
        "question_en": "How do you implement deep copy?",
        "question_hi": "डीप कॉपी कैसे इम्प्लीमेंट करते हैं?",
    ...
    },
    {
        ...
        "options_en": ["Yield processor to other goroutines", "Schedule goroutines", "Stop goroutine", "Start goroutine"],
        "options_hi": ["प्रोसेसर को अन्य गोरूटीन्स को यील्ड करना", "गोरूटीन्स शेड्यूल करना", "गोरूटीन रोकना", "गोरूटीन शुरू करना"],
        "answer_en": "Yield processor to other goroutines",
        "answer_hi": "प्रोसेसर को अन्य गोरूटीन्स को यील्ड करना",
        "attempted": false,
        "selected": ""
    },
    {
        "num": 12,
        "question_en": "How do you implement plugin architecture?",
    ...
    },
    {
        ...
        "options_en": ["Store request-scoped values", "Add values to context", "For data passing", "All of the above"],
        "options_hi": ["रिक्वेस्ट-स्कोप्ड वैल्यूज स्टोर करना", "कॉन्टेक्स्ट में वैल्यूज ऐड करना", "डेटा पासिंग के लिए", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 14,
        "question_en": "How do you implement binary serialization?",
        "question_hi": "बाइनरी सीरियलाइजेशन कैसे इम्प्लीमेंट करते हैं?",
    ...
    },
    {
        ...
        "options_en": ["Embed files in binary", "Include static files", "For file embedding", "All of the above"],
        "options_hi": ["बाइनरी में फाइल्स एम्बेड करना", "स्टेटिक फाइल्स इनक्लूड करना", "फाइल एम्बेडिंग के लिए", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 18,
        "question_en": "How do you implement circuit breaking?",
        "question_hi": "सर्किट ब्रेकिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 20,
        "question_en": "How do you implement memory profiling?",
    ...
    {
        "num": 22,
        "question_en": "How do you implement hot reloading?",
    ...
    {
        "num": 24,
        "question_en": "How do you implement gRPC?",
        "question_hi": "gRPC कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 26,
        "question_en": "How do you implement WebSocket?",
        "question_hi": "WebSocket कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 29,
        "question_en": "What is the purpose of 'io.Writer' interface?",
    ...
    {
        "num": 30,
        "question_en": "How do you implement cron jobs?",
        "question_hi": "cron जॉब्स कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 32,
        "question_en": "How do you implement GraphQL?",
        "question_hi": "GraphQL कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 34,
        "question_en": "How do you implement OAuth2?",
        "question_hi": "OAuth2 कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 35,
        "question_en": "What is the purpose of 'text/template'?",
        "question_hi": "'text/template' का उद्देश्य क्या है?",
    ...
    },
    {
        ...
        "question_hi": "डिस्ट्रीब्यूटेड लॉक्स कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 38,
        "question_en": "How do you implement load testing?",
        "question_hi": "लोड टेस्टिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 39,
        "question_en": "What is the purpose of 'go/ast' package?",
    ...
    },
    {
        ...
        "question_hi": "फीचर टॉगल्स कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 41,
        "question_en": "What is the purpose of 'go/parser' package?",
    ...
    {
        "num": 42,
        "question_en": "How do you implement API mocking?",
        "question_hi": "API मॉकिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 43,
        "question_en": "What is the purpose of 'go/types' package?",
    ...
    {
        "num": 44,
        "question_en": "How do you implement database transactions?",
        "question_hi": "डेटाबेस ट्रांजैक्शन कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 46,
        "question_en": "How do you implement content negotiation?",
    ...
    {
        "num": 48,
        "question_en": "How do you implement API versioning with headers?",
        "question_hi": "हेडर के साथ API वर्जनिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 49,
        "question_en": "What is the purpose of 'sort' package?",
    ...
    {
        "num": 50,
        "question_en": "How do you implement request validation?",
        "question_hi": "रिक्वेस्ट वैलिडेशन कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 51,
        "question_en": "What is the purpose of 'strings' package?",
    ...
    {
        "num": 52,
        "question_en": "How do you implement CORS?",
        "question_hi": "CORS कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 53,
        "question_en": "What is the purpose of 'bytes' package?",
    ...
    {
        "num": 54,
        "question_en": "How do you implement rate limiting by IP?",
        "question_hi": "IP द्वारा रेट लिमिटिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 55,
        "question_en": "What is the purpose of 'strconv' package?",
    ...
    {
        "num": 56,
        "question_en": "How do you implement graceful database connection handling?",
        "question_hi": "ग्रेसफुल डेटाबेस कनेक्शन हैंडलिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 58,
        "question_en": "How do you implement API key authentication?",
        "question_hi": "API की ऑथेंटिकेशन कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 60,
        "question_en": "How do you implement JWT authentication?",
        "question_hi": "JWT ऑथेंटिकेशन कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 62,
        "question_en": "How do you implement request/response logging?",
        "question_hi": "रिक्वेस्ट/रिस्पॉन्स लॉगिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 66,
        "question_en": "How do you implement file upload handling?",
        "question_hi": "फाइल अपलोड हैंडलिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 67,
        "question_en": "What is the purpose of 'net/mail' package?",
        "question_hi": "'net/mail' पैकेज का उद्देश्य क्या है?",
    ...
    {
        "num": 68,
        "question_en": "How do you implement email sending?",
        "question_hi": "ईमेल सेंडिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    },
    {
        ...
        "question_hi": "HTTP हैंडलर्स में पैनिक रिकवरी कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 74,
        "question_en": "How do you implement request deduplication?",
    ...
    {
        "num": 76,
        "question_en": "How do you implement request tracing?",
        "question_hi": "रिक्वेस्ट ट्रेसिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 78,
        "question_en": "How do you implement database connection retry logic?",
        "question_hi": "डेटाबेस कनेक्शन रिट्राई लॉजिक कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 79,
        "question_en": "What is the purpose of 'unicode' package?",
    ...
    {
        "num": 82,
        "question_en": "How do you implement background task scheduling?",
        "question_hi": "बैकग्राउंड टास्क शेड्यूलिंग कैसे इम्प्लीमेंट करते हैं?",
    ...
    {
        "num": 85,
        "question_en": "What is the purpose of 'go/build' package?",
    ...
    {
        "num": 86,
        "question_en": "How do you implement circuit breaker with state management?",
        "question_hi": "स्टेट मैनेजमेंट के साथ सर्किट ब्रेकर कैसे इम्प्लीमेंट करते हैं?",
    ...
    },
    {
        ...
        "options_en": ["Clean up dependencies", "Add missing dependencies", "Remove unused dependencies", "All of the above"],
        "options_hi": ["डिपेंडेंसीज क्लीन अप करना", "मिसिंग डिपेंडेंसीज ऐड करना", "अनयूज्ड डिपेंडेंसीज रिमूव करना", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["Using Shutdown() method", "Handling OS signals", "Using context cancellation", "All of the above"],
        "options_hi": ["Shutdown() मेथड का उपयोग करके", "OS सिग्नल्स हैंडलिंग करके", "कॉन्टेक्स्ट कैंसलेशन का उपयोग करके", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 89,
        "question_en": "What is the purpose of 'errors.Is' function?",
        "question_hi": "'errors.Is' फंक्शन का उद्देश्य क्या है?",
        "options_en": ["Check error equality", "Compare errors", "Error wrapping check", "All of the above"],
        "options_hi": ["एरर इक्वलिटी चेक करना", "एरर्स कम्पेयर करना", "एरर रैपिंग चेक करना", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 90,
        "question_en": "How do you implement custom error types?",
        "question_hi": "कस्टम एरर टाइप्स कैसे इम्प्लीमेंट करते हैं?",
        "options_en": ["Implement Error() method", "Using struct types", "Using error interfaces", "All of the above"],
        "options_hi": ["Error() मेथड इम्प्लीमेंट करके", "स्ट्रक्ट टाइप्स का उपयोग करके", "एरर इंटरफेस का उपयोग करके", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["Wait for goroutines completion", "Synchronize goroutines", "Coordinate multiple goroutines", "All of the above"],
        "options_hi": ["गोरूटीन्स कम्प्लीशन के लिए इंतज़ार करना", "गोरूटीन्स सिंक्रोनाइज करना", "मल्टीपल गोरूटीन्स कोऑर्डिनेट करना", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 92,
        "question_en": "How do you implement health checks in microservices?",
        "question_hi": "माइक्रोसर्विसेज में हेल्थ चेक्स कैसे इम्प्लीमेंट करते हैं?",
        "options_en": ["Using /health endpoint", "Database connectivity checks", "External service checks", "All of the above"],
        "options_hi": ["/health एंडपॉइंट का उपयोग करके", "डेटाबेस कनेक्टिविटी चेक्स", "एक्सटर्नल सर्विस चेक्स", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 93,
        "question_en": "What is the purpose of 'io.MultiWriter'?",
        "question_hi": "'io.MultiWriter' का उद्देश्य क्या है?",
        "options_en": ["Write to multiple writers", "Broadcast data streams", "Duplicate output", "All of the above"],
        "options_hi": ["मल्टीपल राइटर्स को राइट करना", "डेटा स्ट्रीम्स ब्रॉडकास्ट करना", "आउटपुट डुप्लिकेट करना", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 94,
        "question_en": "How do you implement data race detection?",
        "question_hi": "डेटा रेस डिटेक्शन कैसे इम्प्लीमेंट करते हैं?",
        "options_en": ["Using -race flag", "Using sync/atomic", "Using mutexes", "All of the above"],
        "options_hi": ["-race फ्लैग का उपयोग करके", "sync/atomic का उपयोग करके", "म्यूटेक्स का उपयोग करके", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 95,
        "question_en": "What is the purpose of 'net/http/httputil' package?",
        "question_hi": "'net/http/httputil' पैकेज का उद्देश्य क्या है?",
        "options_en": ["HTTP utilities", "Reverse proxy", "Request/response debugging", "All of the above"],
        "options_hi": ["HTTP यूटिलिटीज", "रिवर्स प्रॉक्सी", "रिक्वेस्ट/रिस्पॉन्स डीबगिंग", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["Using Consul", "Using etcd", "Using custom registry", "All of the above"],
        "options_hi": ["Consul का उपयोग करके", "etcd का उपयोग करके", "कस्टम रजिस्ट्री का उपयोग करके", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["Set timeout duration", "Cancel after timeout", "Timeout-based operations", "All of the above"],
        "options_hi": ["टाइमआउट ड्यूरेशन सेट करना", "टाइमआउट के बाद कैंसल करना", "टाइमआउट-बेस्ड ऑपरेशन्स", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 98,
        "question_en": "How do you implement middleware chaining?",
        "question_hi": "मिडलवेयर चेनिंग कैसे इम्प्लीमेंट करते हैं?",
        "options_en": ["Using HandlerFunc", "Using nested handlers", "Using middleware libraries", "All of the above"],
        "options_hi": ["HandlerFunc का उपयोग करके", "नेस्टेड हैंडलर्स का उपयोग करके", "मिडलवेयर लाइब्रेरी का उपयोग करके", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    ...
    {
        "num": 99,
        "question_en": "What is the purpose of 'go:build' directives?",
        "question_hi": "'go:build' डायरेक्टिव्स का उद्देश्य क्या है?",
        "options_en": ["Build constraints", "Platform-specific code", "Conditional compilation", "All of the above"],
        "options_hi": ["बिल्ड कंस्ट्रेंट्स", "प्लेटफॉर्म-स्पेसिफिक कोड", "कंडीशनल कम्पाइलेशन", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
    },
    {
        ...
        "options_en": ["Using interfaces", "Constructor injection", "Using DI containers", "All of the above"],
        "options_hi": ["इंटरफेस का उपयोग करके", "कंस्ट्रक्टर इंजेक्शन", "DI कंटेनर्स का उपयोग करके", "उपरोक्त सभी"],
        "answer_en": "All of the above",
        "answer_hi": "उपरोक्त सभी",
        "attempted": false,
        "selected": ""
