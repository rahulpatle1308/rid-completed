const questions=[
  ...
  {
    "num": 50,
    "question_en": "Which method emits an event in an EventEmitter instance?",
    "question_hi": "EventEmitter instance में event emit करने वाला method कौन सा है?",
    "options_en": ["emit()", "trigger()", "dispatch()", "fire()"],
    "options_hi": ["emit()", "trigger()", "dispatch()", "fire()"],
    "answer_en": "emit()",
    "answer_hi": "emit()"
  }
]
